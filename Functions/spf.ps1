function spf() {
    ...
    $spf_location = "C:\Users\omaro\AppData\Local\Microsoft\WinGet\Packages\yorukot.superfile_Microsoft.Winget.Source_8wekyb3d8bbwe\dist\superfile-windows-v1.4.0-amd64\spf.exe"
